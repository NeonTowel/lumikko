...
app.use('/api/*', cors({
  origin: '*', // Or set to your UI's URL for production
  allowMethods: ['POST', 'OPTIONS'],
  allowHeaders: ['Content-Type', 'Authorization'],
}));

// Refactored function to call Azure OpenAI
...
// Existing endpoint, now using the refactored function
...
// New endpoint with recommendations
app.post("/api/generate_with_recommendations", async (c) => {
  const body = await c.req.json();
